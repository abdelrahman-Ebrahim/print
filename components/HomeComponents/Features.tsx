...
const Features = () => {
    ...
    return (
        <>
            ...
            <section id='features' className='general-container py-8 gap-[10px] w-full flex flex-col items-center justify-center lg:gap-[45px] lg:py-10 xlg:!py-20 overflow-hidden'>
